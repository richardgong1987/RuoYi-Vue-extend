...
CREATE TABLE `file_store_mapping` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文件关系';

-- ----------------------------
-- Records of file_store_mapping
-- ----------------------------
BEGIN;
INSERT INTO `file_store_mapping` VALUES (2000, 1, 2000, 'Snipaste_2022-02-09_10-09-47.png', 'http://localhost:9000/education/2022/02/11/74983f91-c4c6-40a7-8367-498c9f45c35a/Snipaste_2022-02-09_10-09-47.png', 0, '', '2022-02-11 23:22:49', '', NULL, '');
INSERT INTO `file_store_mapping` VALUES (2001, 1, 2000, 'Snipaste_2022-02-08_20-30-58.png', 'http://localhost:9000/education/2022/02/11/e0ce7fff-2bfd-4e0e-8104-670e0c3bcc27/Snipaste_2022-02-08_20-30-58.png', 0, '', '2022-02-11 23:31:05', '', NULL, '');
INSERT INTO `file_store_mapping` VALUES (2003, 1, 2000, 'Snipaste_2022-02-11_14-49-40.png', 'http://localhost:9000/education/2022/02/11/8450578c-5b63-447b-ac12-c4e47c3406dd/Snipaste_2022-02-11_14-49-40.png', 0, '', '2022-02-11 23:33:32', '', NULL, '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `file_store_menu` VALUES (2000, '测试', 0, 0, '', NULL, NULL, 1, 0, 'M', '0', '0', '', '#', 'admin', '2022-02-11 17:32:30', 'admin', '2022-02-11 23:33:31', '');
...
INSERT INTO `sys_menu` VALUES (3000, '会员管理', 0, 10, 'peoples', '', NULL, 1, 0, 'M', '0', '0', '', 'product', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-目录');
INSERT INTO `sys_menu` VALUES (3001, '学校管理', 3000, 1, 'managementSchools', 'peoples/managementSchools/index', '', 1, 0, 'C', '0', '0', 'peoples:managementSchools:list', 'product-list', 'admin', '2022-02-11 09:11:51', '', NULL, '学校管理-菜单');
INSERT INTO `sys_menu` VALUES (3002, '查询', 3001, 1, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementSchools:query', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学校管理-查询-按钮');
INSERT INTO `sys_menu` VALUES (3003, '添加', 3001, 2, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementSchools:add', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学校管理-添加-按钮');
INSERT INTO `sys_menu` VALUES (3004, '编辑', 3001, 3, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementSchools:edit', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学校管理-编辑-按钮');
INSERT INTO `sys_menu` VALUES (3005, '删除', 3001, 4, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementSchools:remove', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学校管理-删除-按钮');
INSERT INTO `sys_menu` VALUES (3006, '导入', 3001, 5, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementSchools:import', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学校管理-导入-按钮');
INSERT INTO `sys_menu` VALUES (3007, '导出', 3001, 6, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementSchools:export', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学校管理-导出-按钮');
INSERT INTO `sys_menu` VALUES (3008, '班级管理', 3000, 2, 'managementClasses', 'peoples/managementClasses/index', '', 1, 0, 'C', '0', '0', 'peoples:managementClasses:list', 'product-list', 'admin', '2022-02-11 09:11:51', '', NULL, '班级管理-菜单');
INSERT INTO `sys_menu` VALUES (3009, '查询', 3008, 1, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementClasses:query', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '班级管理-查询-按钮');
INSERT INTO `sys_menu` VALUES (3010, '添加', 3008, 2, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementClasses:add', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '班级管理-添加-按钮');
INSERT INTO `sys_menu` VALUES (3011, '编辑', 3008, 3, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementClasses:edit', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '班级管理-编辑-按钮');
INSERT INTO `sys_menu` VALUES (3012, '删除', 3008, 4, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementClasses:remove', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '班级管理-删除-按钮');
INSERT INTO `sys_menu` VALUES (3013, '导入', 3008, 5, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementClasses:import', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '班级管理-导入-按钮');
INSERT INTO `sys_menu` VALUES (3014, '导出', 3008, 6, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementClasses:export', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '班级管理-导出-按钮');
INSERT INTO `sys_menu` VALUES (3015, '学生管理', 3000, 3, 'managementStudents', 'peoples/managementStudents/index', '', 1, 0, 'C', '0', '0', 'peoples:managementStudents:list', 'product-list', 'admin', '2022-02-11 09:11:51', '', NULL, '学生管理-菜单');
INSERT INTO `sys_menu` VALUES (3016, '查询', 3015, 1, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementStudents:query', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学生管理-查询-按钮');
INSERT INTO `sys_menu` VALUES (3017, '添加', 3015, 2, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementStudents:add', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学生管理-添加-按钮');
INSERT INTO `sys_menu` VALUES (3018, '编辑', 3015, 3, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementStudents:edit', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学生管理-编辑-按钮');
INSERT INTO `sys_menu` VALUES (3019, '删除', 3015, 4, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementStudents:remove', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学生管理-删除-按钮');
INSERT INTO `sys_menu` VALUES (3020, '导入', 3015, 5, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementStudents:import', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学生管理-导入-按钮');
INSERT INTO `sys_menu` VALUES (3021, '导出', 3015, 6, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementStudents:export', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '学生管理-导出-按钮');
INSERT INTO `sys_menu` VALUES (3022, '会员管理', 3000, 4, 'managementMemberships', 'peoples/managementMemberships/index', '', 1, 0, 'C', '0', '0', 'peoples:managementMemberships:list', 'product-list', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-菜单');
INSERT INTO `sys_menu` VALUES (3023, '查询', 3022, 1, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementMemberships:query', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-查询-按钮');
INSERT INTO `sys_menu` VALUES (3024, '添加', 3022, 2, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementMemberships:add', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-添加-按钮');
INSERT INTO `sys_menu` VALUES (3025, '编辑', 3022, 3, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementMemberships:edit', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-编辑-按钮');
INSERT INTO `sys_menu` VALUES (3026, '删除', 3022, 4, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementMemberships:remove', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-删除-按钮');
INSERT INTO `sys_menu` VALUES (3027, '导入', 3022, 5, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementMemberships:import', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-导入-按钮');
INSERT INTO `sys_menu` VALUES (3028, '导出', 3022, 6, '', '', '', 1, 0, 'F', '0', '0', 'peoples:managementMemberships:export', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '会员管理-导出-按钮');
INSERT INTO `sys_menu` VALUES (3029, '资料管理', 0, 20, 'material', '', NULL, 1, 0, 'M', '0', '0', '', 'upload', 'admin', '2022-02-11 09:11:51', '', NULL, '资料管理-目录');
INSERT INTO `sys_menu` VALUES (3030, '文件管理', 3029, 1, 'fileDrive', 'material/fileDrive/index', '', 1, 0, 'C', '0', '0', 'material:fileDrive:list', 'dengji', 'admin', '2022-02-11 09:11:51', '', NULL, '文件管理-菜单');
INSERT INTO `sys_menu` VALUES (3031, '查询', 3030, 1, '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:query', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '文件管理-查询-按钮');
INSERT INTO `sys_menu` VALUES (3032, '添加', 3030, 2, '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:add', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '文件管理-添加-按钮');
INSERT INTO `sys_menu` VALUES (3033, '编辑', 3030, 3, '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:edit', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '文件管理-编辑-按钮');
INSERT INTO `sys_menu` VALUES (3034, '删除', 3030, 4, '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:remove', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '文件管理-删除-按钮');
INSERT INTO `sys_menu` VALUES (3035, '导入', 3030, 5, '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:import', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '文件管理-导入-按钮');
INSERT INTO `sys_menu` VALUES (3036, '导出', 3030, 6, '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:export', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '文件管理-导出-按钮');
INSERT INTO `sys_menu` VALUES (3037, '老师管理', 0, 30, 'teachers', '', NULL, 1, 0, 'M', '0', '0', '', 'example', 'admin', '2022-02-11 09:11:51', '', NULL, '老师管理-目录');
INSERT INTO `sys_menu` VALUES (3038, '老师信息', 3037, 1, 'teacherInfos', 'teachers/teacherInfos/index', '', 1, 0, 'C', '0', '0', 'teachers:teacherInfos:list', 'article', 'admin', '2022-02-11 09:11:51', '', NULL, '老师信息-菜单');
INSERT INTO `sys_menu` VALUES (3039, '查询', 3038, 1, '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:query', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '老师信息-查询-按钮');
INSERT INTO `sys_menu` VALUES (3040, '添加', 3038, 2, '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:add', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '老师信息-添加-按钮');
INSERT INTO `sys_menu` VALUES (3041, '编辑', 3038, 3, '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:edit', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '老师信息-编辑-按钮');
INSERT INTO `sys_menu` VALUES (3042, '删除', 3038, 4, '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:remove', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '老师信息-删除-按钮');
INSERT INTO `sys_menu` VALUES (3043, '导入', 3038, 5, '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:import', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '老师信息-导入-按钮');
INSERT INTO `sys_menu` VALUES (3044, '导出', 3038, 6, '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:export', '#', 'admin', '2022-02-11 09:11:51', '', NULL, '老师信息-导出-按钮');
COMMIT;
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=134 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2022-02-12 10:54:43', 'admin', '2022-01-08 16:34:04', '', '2022-02-12 10:54:43', '管理员');
