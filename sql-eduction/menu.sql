...
WHERE menu_id=4;
        ...
        INSERT INTO sys_menu
        VALUES ('3032', '查询', '3030', '1', '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:query',
                '#', 'admin', SYSDATE(), '', NULL, '文件管理-查询-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3033', '添加', '3030', '2', '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:add',
                '#', 'admin', SYSDATE(), '', NULL, '文件管理-添加-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3034', '编辑', '3030', '3', '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:edit',
                '#', 'admin', SYSDATE(), '', NULL, '文件管理-编辑-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3035', '删除', '3030', '4', '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:remove',
                '#', 'admin', SYSDATE(), '', NULL, '文件管理-删除-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3036', '导入', '3030', '5', '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:import',
                '#', 'admin', SYSDATE(), '', NULL, '文件管理-导入-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3037', '导出', '3030', '6', '', '', '', 1, 0, 'F', '0', '0', 'material:fileDrive:export',
                '#', 'admin', SYSDATE(), '', NULL, '文件管理-导出-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3031', '文件夹管理', '3029', '2', 'folder', 'material/folder/index',
                '', 1, 0, 'C', '0', '0', 'material:folder:list', 'dengji', 'admin', SYSDATE(), '', NULL, '文件夹管理-菜单');
    
        INSERT INTO sys_menu
        VALUES ('3038', '老师管理', '0', '30', 'teachers', '', NULL, 1, 0, 'M', '0',
                '0', '', 'example', 'admin', SYSDATE(), '', NULL, '老师管理-目录');
    
        INSERT INTO sys_menu
        VALUES ('3039', '老师信息', '3038', '1', 'teacherInfos', 'teachers/teacherInfos/index',
                '', 1, 0, 'C', '0', '0', 'teachers:teacherInfos:list', 'article', 'admin', SYSDATE(), '', NULL, '老师信息-菜单');
    
        INSERT INTO sys_menu
        VALUES ('3040', '查询', '3039', '1', '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:query',
                '#', 'admin', SYSDATE(), '', NULL, '老师信息-查询-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3041', '添加', '3039', '2', '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:add',
                '#', 'admin', SYSDATE(), '', NULL, '老师信息-添加-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3042', '编辑', '3039', '3', '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:edit',
                '#', 'admin', SYSDATE(), '', NULL, '老师信息-编辑-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3043', '删除', '3039', '4', '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:remove',
                '#', 'admin', SYSDATE(), '', NULL, '老师信息-删除-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3044', '导入', '3039', '5', '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:import',
                '#', 'admin', SYSDATE(), '', NULL, '老师信息-导入-按钮');
    
        INSERT INTO sys_menu
        VALUES ('3045', '导出', '3039', '6', '', '', '', 1, 0, 'F', '0', '0', 'teachers:teacherInfos:export',
